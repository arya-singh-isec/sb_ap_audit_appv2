...
class RejectedRecordPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => QuestionCubit(getQuestions: getQuestion)..fetchQuestions(),
      child: Scaffold(
        appBar: AppBar(
              ...
              return Column(
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: const [
                        Expanded(child: Text('Ques. No', textAlign: TextAlign.center)),
                        Expanded(child: Text('Sub broker', textAlign: TextAlign.center)),
                        Expanded(child: Text('Reviewer', textAlign: TextAlign.center)),
                        Expanded(child: Text('Corporate', textAlign: TextAlign.center)),
                      ],
                    ),
                  ),
                  Expanded(
